...
\*\*[Random Users] is an app which fetches user data from a Random User API and displays their information
...
```sh
  ...
  git clone https://github.com/Kevin-Mena/random-user.git
...
Feel free to check the [issues page](https://github.com/Kevin-Mena/random-user/issues).
